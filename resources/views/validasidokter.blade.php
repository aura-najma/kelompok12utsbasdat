...
<div class="container mt-5">
    ...
    <thead>
        <tr>
            ...
            <th>Alamat</th>
            <th>Hubungi</th>
            <th>Action</th> <!-- Kolom untuk Delete -->
        </tr>
    </thead>
    <tbody>
        @foreach ($dokters as $dokter)
            <tr>
                ...
                <td>
                <form action="{{ route('dokter.destroy', $dokter->nomor_str) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                        @csrf
                        @method('DELETE')
